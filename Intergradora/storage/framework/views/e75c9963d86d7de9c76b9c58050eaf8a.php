...
<form action="<?php echo e(url('/clientes')); ?>" method="POST" class="form-container">
    <?php echo csrf_field(); ?>
    ...
    <a href="<?php echo e(url('/clientes')); ?>" class="btn btn-secondary">Cancelar</a>

</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("base", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Almacen-MiBarrio\resources\views/clientes.blade.php ENDPATH**/ ?>